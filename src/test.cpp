...
std::string idString(const std::vector<std::vector<ctts::Phoneme>> &phonemes,
                     ctts::PhonemeIdConfig &idConfig) {
  std::map<ctts::Phoneme, std::size_t> missingPhonemes;
  std::stringstream idStr;
  for (auto sentPhonemes : phonemes) {
    std::vector<ctts::PhonemeId> sentIds;
    ctts::phonemes_to_ids(sentPhonemes, idConfig, sentIds, missingPhonemes);
...
std::string
phonemeString(const std::vector<std::vector<ctts::Phoneme>> &phonemes) {
...
int main(int argc, char *argv[]) {
  ...
  ctts::eSpeakPhonemeConfig phonemeConfig;
  ctts::PhonemeIdConfig idConfig;
  ...
  ctts::phonemize_eSpeak("licht!", phonemeConfig, phonemes);
  ...
  ctts::phonemize_eSpeak("this, is: a; test.", phonemeConfig, phonemes);
  ...
  ctts::phonemize_eSpeak("Test 1. Test 2.", phonemeConfig, phonemes);
  ...
  ctts::CodepointsPhonemeConfig codepointsConfig;
  phonemes.clear();

  ctts::phonemize_codepoints("ВЕСЕ́ЛКА", codepointsConfig, phonemes);

  // Case folded and NFD normalized
  std::vector<ctts::Phoneme> expectedPhonemes = {U'в', U'е', U'с', U'е',
                                                  U'́',  U'л', U'к', U'а'};
  ...
  idConfig.phonemeIdMap =
      std::make_shared<ctts::PhonemeIdMap>(ctts::DEFAULT_ALPHABET["uk"]);
  ...
  std::vector<ctts::PhonemeId> missingIds;
  std::map<ctts::Phoneme, std::size_t> missingPhonemes;
  ctts::phonemes_to_ids(phonemes[0], idConfig, missingIds, missingPhonemes);
